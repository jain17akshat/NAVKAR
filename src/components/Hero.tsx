...
const Hero = () => {
  return (
    <section id="home" className="bg-gradient-to-r from-navyellow-light to-navyellow py-16 md:py-28">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 relative animate-fade-in">
            <div className="aspect-square bg-white p-2 rounded-lg shadow-lg transform rotate-3 max-w-xs sm:max-w-sm mx-auto md:mx-0">
              <img
            ...
            <div className="absolute -bottom-5 -left-5 sm:-bottom-10 sm:-left-10 w-24 h-24 sm:w-44 sm:h-44 bg-white p-2 rounded-lg shadow-lg transform -rotate-6 hidden sm:block">
              <img
